        ...
        <section className={styles.section} id="verify">
          <div className="shell">
            ...
            <p className={styles.lede}>
              ...
              <code className={styles.code}>aestrodom/proof USDe</code> in the console above and paste
              what it gives you into a terminal. If our number is wrong, that is how you find out.
            </p>
            <div className={styles.links}>
              <a className={styles.link} href="https://github.com/aestrodom/aestrodom">
                Source and daily snapshots →
              </a>
              <Link className={styles.link} href="/docs">
                Method in full →
              </Link>
              <a className={styles.link} href="https://x.com/aestrodom">
                @aestrodom →
              </a>
            </div>
          </div>
