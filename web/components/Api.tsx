...
const STEPS = [
  ...
  { text: <>Send the USDG to the address in the response. Your wallet, your gas, your call.</> },
  {
    text: (
      <>
        Sign <code>aestrodom-pass:&lt;tx hash&gt;</code> with the wallet that paid, and retry with{" "}
...
const BY_HAND = [
  <>
    <code>aestrodom/live USDe 1000000</code> — the console calls this endpoint for real and prints the
    402 it gets back, with the address to pay.
  </>,
  <>Send the USDG from your own wallet. Nothing on this page can move your funds.</>,
  <>
    <code>aestrodom/pay 0x…</code> — your wallet signs the hash (one click, moves nothing), and the
